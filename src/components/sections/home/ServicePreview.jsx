...
export default function ServicePreview() {
  ...
  // Show only featured services (limited to 3) on homepage
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {featuredServices.map((service) => (
            <Link 
              ...
              className="group flex flex-col p-6 card-blur-bg rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300"
            >
              ...
              <p className="text-white flex-grow mb-4">
                {service.description}
              </p>
              <div className="text-white font-medium flex items-center group-hover:underline">
